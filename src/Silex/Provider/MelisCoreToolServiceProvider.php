...
class MelisCoreToolServiceProvider implements ServiceProviderInterface
{
    public function register(Container $app)
    {
        # Initializing Service
        $app['MelisCoreTool'] = function ($app) {
            ...
            /** @var  $MelisCoreTool  \MelisCore\Service\MelisCoreToolService*/
            $MelisCoreTool = $serviceManager->get('MelisCoreTool');
